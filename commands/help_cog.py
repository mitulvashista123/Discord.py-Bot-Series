...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        owner_name = "You Know Who I am#7757"
        ...
        if not input:
            ...
            emb.add_field(name="About", value=f"{mention} was invented by Tony Stark, based on discord.py.\n\
                                    This version of it is maintained by {owner}\n\
                                    Please visit https://github.com/mitulvashista123/Discord.py-Bot-Series to submit ideas or bugs.")
            emb.set_footer(text="©️Stark Industries.")
